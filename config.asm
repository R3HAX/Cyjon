...
%define	VARIABLE_KERNEL_VERSION			"0.501"
...
VARIABLE_COLOR_BACKGROUND_GRAY			equ	0x80
VARIABLE_COLOR_BACKGROUND_LIGHT_BLUE		equ	0x90
VARIABLE_COLOR_BACKGROUND_LIGHT_GREEN		equ	0xA0
VARIABLE_COLOR_BACKGROUND_LIGHT_CYAN		equ	0xB0
VARIABLE_COLOR_BACKGROUND_LIGHT_RED		equ	0xC0
VARIABLE_COLOR_BACKGROUND_LIGHT_VIOLET		equ	0xD0
VARIABLE_COLOR_BACKGROUND_YELLOW		equ	0xE0
VARIABLE_COLOR_BACKGROUND_WHITE			equ	0xF0
